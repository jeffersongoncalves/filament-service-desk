...
namespace JeffersonGoncalves\FilamentServiceDesk\Resources\Admin;
...
use JeffersonGoncalves\FilamentServiceDesk\Resources\Admin\KbArticleResource\Pages;
use JeffersonGoncalves\FilamentServiceDesk\Resources\Admin\KbArticleResource\RelationManagers;
                        ...
                        Forms\Components\Section::make(__('filament-service-desk::service-desk.sections.content'))
                            ->schema([
                                ...
                                Forms\Components\TextInput::make('slug')
                                    ->label(__('filament-service-desk::service-desk.fields.slug'))
                                    ->required()
                                    ->maxLength(255)
